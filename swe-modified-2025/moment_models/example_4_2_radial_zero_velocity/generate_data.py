#!/usr/bin/env python3
"""Generate the Example 4.2 radial zero-velocity moment-model data."""
...
def parser() -> argparse.ArgumentParser:
    ...
    result.add_argument("--var-num", type=int, nargs="+", default=[3, 5, 7])
    result.add_argument(
        "--model-type",
...
def model_filename(model_type: str, var_num: int, nx: int, kappa: float) -> str:
    ...
    return f"zero{prefix}{moment_num}_N{nx}_k{kappa:.1e}.npy"
